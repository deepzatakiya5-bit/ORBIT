...
import { getLastHometownVisit, getTimeline, getTravelFrequency, } from "../../services/timelineService.js";
...
routes.post("/internal/events/conversation-updated", async (req, res, next) => {
    try {
        const body = z
            ...
            .parse(req.body);
        await extractionQueue.add("extract", body, { attempts: 5, backoff: { type: "exponential", delay: 2000 } });
